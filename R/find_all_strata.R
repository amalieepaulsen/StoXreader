...
find_all_strata <- function(path) {
  ...
  stoxvector <- stox_vector(path = path)
  ...
  # n_skip[1] - 4: The location of every "Stratum:" is always 4 spaces above
  # "Lengrp". Starting at first string occurrence to extract stratum numbers.
  suppressWarnings({
