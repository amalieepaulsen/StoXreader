...
test_that("test mainfunc 2009", {
  a_path <- system.file(
    ...
    package = "StoXreader")
  b_path <- system.file(
    "extdata/stox_winter_2009/2_EstimateByPopulationCategory_Reports_Biomass.txt",
    package = "StoXreader")
  w_path <- system.file(
    "extdata/stox_winter_2009/2_EstimateByPopulationCategory_Reports_MeanWeight.txt",
    package = "StoXreader")
  x <- read_stox(a_path, b_path, w_path)
...
test_that("test mainfunc 1999", {
  a_path <- system.file(
    ...
    package = "StoXreader")
  b_path <- system.file(
    "extdata/stox_winter_1999/2_EstimateByPopulationCategory_Reports_Biomass.txt",
    package = "StoXreader")
  w_path <- system.file(
